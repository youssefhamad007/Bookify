...
const LoginForm = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-10 animate-fade-in" style={{ background: 'linear-gradient(200deg, #5f3b1b, #b36b32, #eac8a0)' }}>
        {/* Centered Card Container */}
        <div className="w-full max-w-6xl bg-white rounded-xl shadow-lg flex flex-col lg:flex-row overflow-hidden">
          {/* Photo Section */}
          <div
            className="w-full lg:w-1/2 h-80 lg:h-180 bg-cover bg-bottom"
          ...
          <div className="w-full lg:w-1/2 p-6 lg:p-8 flex flex-col justify-center">
            ...
            <form className="flex flex-col gap-4 w-full" onSubmit={handleSubmit}>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-gray-50 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-600 transition-all duration-300"
              />
              <p className="text-right text-sm text-[black] hover:text-purple-800 cursor-pointer transition-colors duration-200">
                Forgot Password?
              </p>
              <button
                type="submit"
                className="w-full py-3 bg-[#b36b32] text-white rounded-lg font-semibold hover:bg-[#5f3b1b] focus:outline-none focus:ring-2 focus:ring-purple-600 transition-all duration-300 transform hover:scale-105"
              >
                Log In
              </button>
            </form>
            ...
            <p className="mt-6 text-center text-sm text-gray-600">
              ...
              <span className="text-black hover:text-gray-600 font-semibold cursor-pointer transition-colors duration-200">
                Sign up
              </span>
            </p>
